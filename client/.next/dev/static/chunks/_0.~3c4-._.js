...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setAuth"])(data.token, data.user);
            const target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDashboardPathForRole"])(data.user?.role);
            router.push(target);
        } catch (error) {
            console.error(error);
            alert("Login failed");
...
//# sourceMappingURL=_0.~3c4-._.js.map